...
export function Title({profile, isAuthenticated, logout}){
    ...
    return (
        <div className="title-container">
            <div  onMouseEnter={e=>{toolTipSetter(e,setToolTip,"A tool for uploading media",true)}} 
            onMouseLeave={e=>{toolTipSetter(e,setToolTip,"A tool for uploading media",false)}}
