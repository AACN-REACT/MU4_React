...
import { ReactComponent as PurpleLogo } from "../images/SVG/SVG/boldlogo2.svg"; //svgr
import panelpop from "../images/SVG/panels.svg"; // not svg
...
function TitleBar({ setSidePanel, setRecord, setPendingFloat, shouldRecord }) {
  ...
  return (
    <div className="title-container">
      ...
      <div
        className="panel-pop"
        style={{ backgroundImage: `url(${panelpop})` }}
        onClick={(e) => setSidePanel((s) => !s)}
      >
        P
      </div>
      <div
      ...
      <div
        ...
        className="panel-choose"
        style={{
          backgroundImage: `url(${screenshare})`,
          border: shouldRecord ? "5px solid #fd9741" : "5px solid white",
        }}
        onClick={(e) => setRecord((r) => !r)}
      ></div>
