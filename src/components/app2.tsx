...
export default function App() {
  const [mediaKeyURL, setMediaKeyURL] = React.useState(
    "03D9B0A1-643F-45A9-A075-008A1B1B598B"
  );
  const [identity, isAuthenticated] = useAuth(false, mediaKeyURL);
  ...
  return isAuthenticated ? (
    ...
    <h1>Redirecting to identity server</h1>
  );
}
